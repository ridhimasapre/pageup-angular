...
import { AddDepartmentResponse, DepartmentDeleteResponse, DepartmentPagenatorRequest, DepartmentPagenatorResponse, DepartmentRequest, departmentResponse } from '../Interface/Department';
...
export class DepartmentServiceService {
  ...
  public url=`${environment.apiUrl}/Department`;
  // public PaginatorUrl =`${environment.apiUrl}/api/Paginated/GetDepartment`
  public PaginatorUrl =`${environment.apiUrl}/Paginated/departments`
