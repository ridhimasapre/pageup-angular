...
export class EmployeeService {
  ...
  public pagenationUrl= `${environment.apiUrl}/api/Paginated/GetEmployees`
  ...
  public adminUrl=`${environment.apiUrl}/api/Employees/GetAllManagers`
    ...
    public PagenationDepartment(data:EmployeePagenatorRequest):Observable<EmployeePagenatorResponse>{
